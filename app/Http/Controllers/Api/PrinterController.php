...
class PrinterController extends Controller
{
  ...
  public function index() {
      ...
      ->select('users.name', 'users.id', 'users.profile_picture_url', 'user_address_infos.lat', 'user_address_infos.lng', 'user_address_infos.street_and_number', 'user_address_infos.bus_number', 'user_address_infos.city', 'printers.id as printer_id', 'printers.price', 'printers.format_id', 'printers.color_id')
      ->get();
